...
/*
  ...
  if(howManyTooFar>2 && howManyTooFar<5){
  ...
  double vector_x_par_wall=-vector_x[least_distance_ind]+vector_x[least_distance_one_past_ind];
  double vector_y_par_wall=-vector_y[least_distance_ind]+vector_y[least_distance_one_past_ind];
  double vector_x_per_wall,vector_y_per_wall;
  double modulo_par_wall=sqrt(pow(vector_x_par_wall,2)+pow(vector_y_par_wall,2));
  ...
  double modulo_per_wall=sqrt(pow(vector_x_per_wall,2)+pow(vector_y_per_wall,2));
  /*FALTA COMPLETAR*/double distanceWantedToTheWall=12;
  //v_final_per=v_per_wall-distanceWantedToTheWall*(v_final/|v_final|)
  double v_final_per_x=vector_x_per_wall-distanceWantedToTheWall*vector_x_per_wall/modulo_per_wall;
  double v_final_per_y=vector_y_per_wall-distanceWantedToTheWall*vector_y_per_wall/modulo_per_wall;

  double v_final_par_x=vector_x_par_wall/modulo_par_wall;
  double v_final_par_y=vector_y_par_wall/modulo_par_wall;

  
  /*FALTA COMPLETAR*/double alpha=0.75,bheta=0.25;
  double v_following_wall_x=alpha*v_final_par_x+bheta*v_final_per_x;
  double v_following_wall_y=alpha*v_final_par_y+bheta*v_final_per_y;

  if(howManyTooFar==SENSORSQUANTITY) angle_following_walls=theta;
  else angle_following_walls=atan2(v_following_wall_y,v_following_wall_x);
  ...
  Serial.print(",");
  Serial.print("par:");
  Serial.print(v_final_par_x);
  Serial.print(",");
  Serial.print(v_final_par_y);
  Serial.print("per:");
  Serial.print(v_final_per_x);
  Serial.print(",");
  Serial.print(v_final_per_y);
  Serial.print("angle:");
  Serial.print(angle_following_walls*180/PI);
  Serial.println(")");
}
